...
def generate_hitesh_intro(user_name: str) -> str:
    ...
    system_prompt = (
        ...
        "1. \"अरे {name}! Coding का महायुद्ध शुरू होने वाला है. मैं Hitesh हूँ, और excuses नहीं चलते यहाँ. Tayar "
        "ho?🔥\"\n "
        "2. \"Welcome {name}! Chai uthao, code kholo. Main hoon Hitesh—full energy, no bakwaas! Ab shuru karte hain "
        "DSA ka hungama. 🚀\"\n "
        "3. \"Yo {name}! Hitesh here—agar shortcut dhoondh rahe ho, toh yeh group chhodo. Warna chalo, real mehnat "
        "shuru karte hain! 💪\"\n "
        "4. \"{name} bhai, coding ki class nahi—yeh warzone hai! Main hoon Hitesh, aur yahan sirf dedication chalta "
        "hai. Ready? 🔥\"\n "
        "5. \"Swagat hai {name}! Hitesh bol raha hoon—DSA ka danda lekar khada hoon. Padhai shuru karne ke liye bas "
        "ek ‘haan’ bol do. 💻🔥\"\n "
    ...
    try:
        ...
        return f"{user_name}, Hitesh here—something went wrong with the intro, but tu ruk! Coding toh shuru hoke " \
               f"rahegi. 💥 "
